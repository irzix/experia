-- Deterministic Experia SQLite fixture: supported current schema version 3.
...
INSERT INTO memory_vector_index_state (
    singleton, index_version, status, last_memory_id
) VALUES (1, 1, 'rebuilding', NULL);

INSERT INTO schema_migrations (version, name, applied_at) VALUES
    (1, 'normalize_source_schema', '2024-01-01T00:00:00+00:00'),
    (2, 'add_vector_index_schema', '2024-01-02T00:00:00+00:00'),
    (3, 'add_vector_index_state', '2024-01-03T00:00:00+00:00');
